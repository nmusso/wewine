...
if ($dbh->login_check()){
    ...
    $notifications = $dbh->getNewNotifications($_SESSION["user_id"]);
    if(!isset($_POST["filter"])){
        $notifications = $notifications + $dbh->getOldNotifications($_SESSION["user_id"]);
    ...
    foreach($notificationsType as $type){
        ...
        $result["allnotifications"] = array_merge($result["allnotifications"], $notifications[$type] );
    }
